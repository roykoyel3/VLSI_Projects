...
REM
REM Generated by Vivado on Sun Aug 10 23:37:43 +0530 2025
...
echo "xvlog --incr --relax -prj half_adder_tb_vlog.prj"
call xvlog  --incr --relax -prj half_adder_tb_vlog.prj -log xvlog.log
