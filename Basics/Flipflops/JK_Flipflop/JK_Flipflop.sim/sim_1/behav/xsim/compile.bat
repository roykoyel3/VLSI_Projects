...
REM
REM Generated by Vivado on Tue Aug 12 23:40:55 +0530 2025
...
echo "xvlog --incr --relax -prj jkff_tb_vlog.prj"
call xvlog  --incr --relax -prj jkff_tb_vlog.prj -log xvlog.log
