...
REM
REM Generated by Vivado on Mon Aug 11 23:54:31 +0530 2025
...
echo "xvlog --incr --relax -prj srff_tb_vlog.prj"
call xvlog  --incr --relax -prj srff_tb_vlog.prj -log xvlog.log
