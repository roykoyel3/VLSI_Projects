...
REM
REM Generated by Vivado on Wed Aug 13 00:03:50 +0530 2025
...
echo "xvlog --incr --relax -prj tff_tb_vlog.prj"
call xvlog  --incr --relax -prj tff_tb_vlog.prj -log xvlog.log
