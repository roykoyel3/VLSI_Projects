...
REM
REM Generated by Vivado on Mon Aug 11 17:07:25 +0530 2025
...
echo "xvlog --incr --relax -prj encoder4x2_tb_vlog.prj"
call xvlog  --incr --relax -prj encoder4x2_tb_vlog.prj -log xvlog.log
