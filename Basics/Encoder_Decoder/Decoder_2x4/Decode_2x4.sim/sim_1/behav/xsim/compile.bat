...
REM
REM Generated by Vivado on Mon Aug 11 23:21:15 +0530 2025
...
echo "xvlog --incr --relax -prj decoder2x4_tb_vlog.prj"
call xvlog  --incr --relax -prj decoder2x4_tb_vlog.prj -log xvlog.log
