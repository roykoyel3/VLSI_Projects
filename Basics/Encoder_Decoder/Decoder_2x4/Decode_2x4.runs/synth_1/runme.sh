...
HD_PWD='D:/verilog/Decode_2x4/Decode_2x4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder2x4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder2x4.tcl
