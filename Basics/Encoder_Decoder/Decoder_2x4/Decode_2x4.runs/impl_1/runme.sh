...
HD_PWD='D:/verilog/Decode_2x4/Decode_2x4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder2x4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decoder2x4.tcl -notrace
