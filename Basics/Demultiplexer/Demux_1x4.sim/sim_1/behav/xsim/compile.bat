...
REM
REM Generated by Vivado on Mon Aug 11 15:34:09 +0530 2025
...
echo "xvlog --incr --relax -prj demux1x4_tb_vlog.prj"
call xvlog  --incr --relax -prj demux1x4_tb_vlog.prj -log xvlog.log
