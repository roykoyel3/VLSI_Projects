...
REM
REM Generated by Vivado on Mon Aug 11 11:18:10 +0530 2025
...
echo "xvlog --incr --relax -prj mux2x1_tb_vlog.prj"
call xvlog  --incr --relax -prj mux2x1_tb_vlog.prj -log xvlog.log
