...
REM
REM Generated by Vivado on Mon Aug 11 14:03:59 +0530 2025
...
echo "xvlog --incr --relax -prj mux4x1_tb_vlog.prj"
call xvlog  --incr --relax -prj mux4x1_tb_vlog.prj -log xvlog.log
