...
REM
REM Generated by Vivado on Fri Sep 05 22:29:34 +0530 2025
...
echo "xvlog --incr --relax -prj pipeMIPS32_tb_vlog.prj"
call xvlog  --incr --relax -prj pipeMIPS32_tb_vlog.prj -log xvlog.log
