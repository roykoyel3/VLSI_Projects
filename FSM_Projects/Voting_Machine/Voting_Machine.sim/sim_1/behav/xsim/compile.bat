...
REM
REM Generated by Vivado on Mon Aug 25 23:02:59 +0530 2025
...
echo "xvlog --incr --relax -prj evm_tb_vlog.prj"
call xvlog  --incr --relax -prj evm_tb_vlog.prj -log xvlog.log
