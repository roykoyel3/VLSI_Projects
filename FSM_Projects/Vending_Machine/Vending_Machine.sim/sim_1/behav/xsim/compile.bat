...
REM
REM Generated by Vivado on Thu Sep 04 17:19:45 +0530 2025
...
echo "xvlog --incr --relax -prj vm_tb_vlog.prj"
call xvlog  --incr --relax -prj vm_tb_vlog.prj -log xvlog.log
